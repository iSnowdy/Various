...
public class Car2 {
    ...
    public Car2(String marca, String modelo, String color, String matricula, boolean isEncendido, int marchaActual, int velocidadActual) {
        this.marca = marca;
        this.modelo = modelo;
        this.color = color;
    ...
    public String setMatricula(String matricula) {
        if (matricula.length() != 7) {
            throw new InvalidParameterException("Matricula de =/ 7");
        } else
